                        ...
                        <div class="col">
                            ...
                            if (isset($_POST['submitComment'])){
                                if(empty(trim($_POST['name']))){
                                    $invalidInputName = 'The Namefield is Necessary';
                                }elseif(empty(trim($_POST['comment']))){
                                    $invalidInputComment = 'Comment-content Necessary';
                                }else{
                                $name = $_POST['name'];
                                ...
                                $message = "Your comment was submitted successfully and will appear once approved.";
                                }
                            }
                            ?>
                            <!-- Comment Form -->
