...
if (isset($_POST['login'])){
    if(empty(trim($_POST['email']))) {
        $invalidInputEmail = "E-Mail is Necessary!";
    }

    if(empty(trim($_POST['password']))) {
        $invalidInputPassword = "Password is Necessary!";
    }
    ...
    if(!empty(trim($_POST['email'])) && !empty(trim($_POST['password']))) {
        ...
        header("Location:login.php?err_msg=No user with this information was found.");
        exit();
    }
}
...
<html dir="rtl" lang="fa">
    ...
    <body class="auth">
        <main class="form-signin w-100 m-auto">
            <form method="post">
                <div class="fs-2 fw-bold text-center mb-4">learnphp.io</div>
